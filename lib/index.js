...
function renderFooter() {
  console.log()
  console.log(chalk.bold.blue('Wil') + chalk.bold.green('eys'))
  console.log()
  console.log(
    chalk.bold(
...
const Socket = __importDefault(require('./Socket'))
exports.makeWASocket = Socket.default
...
exports.default = Socket.default
